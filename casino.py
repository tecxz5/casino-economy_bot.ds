...
from enums import ScoreChances
...
class Results:
    ...
    def __init__(self, bets_number: str, *, data: t.Dict[str, int]) -> None:
        self._data = data
    ...
    async def __aexit__(self, exc_type: t.Optional[t.Type[BaseException]], exc_val: t.Optional[BaseException], exc_tb: t.Optional[TracebackType]) -> 'Results':
        return self
    ...
    def _emoji_stats(self) -> t.Dict[str, t.Any]:
        """ Returns a dictionary in which the key is an emoji and the value is the number of times the emoji has been generated. """
        return self._data
